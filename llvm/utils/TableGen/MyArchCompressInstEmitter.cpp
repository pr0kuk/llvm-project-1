//===- MyArchCompressInstEmitter.cpp - Generator for MyArch Compression -===//
//
// Part of the LLVM Project, under the Apache License v2.0 with LLVM Exceptions.
// See https://llvm.org/LICENSE.txt for license information.
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
//
// MyArchCompressInstEmitter implements a tablegen-driven CompressPat based
// MyArch Instruction Compression mechanism.
//
//===--------------------------------------------------------------===//
//
// MyArchCompressInstEmitter implements a tablegen-driven CompressPat Instruction
// Compression mechanism for generating MyArch compressed instructions
...
// 'MyArchGenCompressInstEmitter.inc' which exports two functions for
...
namespace {
class MyArchCompressInstEmitter {
  struct OpData {
...
public:
  MyArchCompressInstEmitter(RecordKeeper &R) : Records(R), Target(R) {}

  void run(raw_ostream &o);
};
} // End anonymous namespace.

bool MyArchCompressInstEmitter::validateRegister(Record *Reg, Record *RegClass) {
...
bool MyArchCompressInstEmitter::validateTypes(Record *DagOpType,
                                             Record *InstOpType,
                                             bool IsSourceInst) {
...
void MyArchCompressInstEmitter::addDagOperandMapping(
...
void MyArchCompressInstEmitter::createDagOperandMapping(
...
void MyArchCompressInstEmitter::createInstOperandMapping(
...
void MyArchCompressInstEmitter::evaluateCompressPat(Record *Rec) {
...
void MyArchCompressInstEmitter::emitCompressInstEmitter(raw_ostream &o,
                                                       EmitterType EType) {
  ...
  if (EType == EmitterType::Compress) {
    ...
    FuncH.indent(27) << "const MyArchSubtarget *Subtarget,\n";
    FuncH.indent(27) << "const MCRegisterInfo &MRI,\n";
    FuncH.indent(27) << "const MCSubtargetInfo &STI) {\n";
  }
...
void MyArchCompressInstEmitter::run(raw_ostream &o) {
...
void EmitCompressInst(RecordKeeper &RK, raw_ostream &OS) {
  MyArchCompressInstEmitter(RK).run(OS);
}
