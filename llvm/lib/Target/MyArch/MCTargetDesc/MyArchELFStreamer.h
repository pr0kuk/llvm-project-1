//===-- MyArchELFStreamer.h - MyArch ELF Target Streamer ---------*- C++ -*--===//
//
...
#ifndef LLVM_LIB_TARGET_MyArch_MyArchELFSTREAMER_H
#define LLVM_LIB_TARGET_MyArch_MyArchELFSTREAMER_H
...
class MyArchTargetELFStreamer : public MyArchTargetStreamer {
private:
...
public:
  ...
  MyArchTargetELFStreamer(MCStreamer &S, const MCSubtargetInfo &STI);
