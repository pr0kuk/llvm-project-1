//===-- MyArchMCCodeEmitter.h - Convert MyArch Code to Machine Code -----------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the MyArchMCCodeEmitter class.
//
//===----------------------------------------------------------------------===//
//

#ifndef LLVM_LIB_TARGET_MyArch_MCTARGETDESC_MyArchMCCODEEMITTER_H
#define LLVM_LIB_TARGET_MyArch_MCTARGETDESC_MyArchMCCODEEMITTER_H
...
public:
  MyArchMCCodeEmitter(const MCInstrInfo &mcii, MCContext &Ctx_, bool IsLittle)
