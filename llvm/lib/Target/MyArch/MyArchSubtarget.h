//===-- MyArchSubtarget.h - Define Subtarget for the MyArch -------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares the MyArch specific subclass of TargetSubtargetInfo.
//
//===----------------------------------------------------------------------===//
...
class MyArchSubtarget : public MyArchGenSubtargetInfo {
  ...
  MyArchSubtarget &initializeSubtargetDependencies(const Triple &TT,
                                                  StringRef CPU,
                                                  StringRef TuneCPU,
                                                  StringRef FS,
                                                  StringRef ABIName);
...
public:
  ...
  MyArchSubtarget(const Triple &TT, StringRef CPU, StringRef TuneCPU,
  ...
  bool isRegisterReservedByUser(Register i) const {
    assert(i < MyArch::NUM_TARGET_REGS && "Register out of range");
