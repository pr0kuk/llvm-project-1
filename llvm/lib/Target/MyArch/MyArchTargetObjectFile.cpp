//===-- MyArchTargetObjectFile.cpp - MyArch Object Info -----------------===//
//
...
void MyArchELFTargetObjectFile::Initialize(MCContext &Ctx,
...
bool MyArchELFTargetObjectFile::isInSmallSection(uint64_t Size) const {
...
// section.
bool MyArchELFTargetObjectFile::isGlobalInSmallSection(
...
MCSection *MyArchELFTargetObjectFile::SelectSectionForGlobal(
...
void MyArchELFTargetObjectFile::getModuleMetadata(Module &M) {
...
bool MyArchELFTargetObjectFile::isConstantInSmallSection(
    const DataLayout &DL, const Constant *CN) const {
  return isInSmallSection(DL.getTypeAllocSize(CN->getType()));
}

MCSection *MyArchELFTargetObjectFile::getSectionForConstant(
