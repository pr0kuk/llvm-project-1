//===-- MyArchISelLowering.h - MyArch DAG Lowering Interface ------*- C++ -*-===//
//
...
public:
  ...
  const MyArchSubtarget &getSubtarget() const { return Subtarget; }
...
#define GET_MyArchVIntrinsicsTable_DECL
#include "MyArchGenSearchableTables.inc"

} // end namespace MyArchVIntrinsicsTable

namespace MyArchZvlssegTable {

struct MyArchZvlsseg {
  unsigned int IntrinsicID;
  unsigned int SEW;
  unsigned int LMUL;
...
#define GET_MyArchZvlssegTable_DECL
#include "MyArchGenSearchableTables.inc"
