//===-- MyArchMachineFunctionInfo.h - Private data used for MyArch ----*- C++ -*-=//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares the MyArch specific subclass of MachineFunctionInfo.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_MyArch_MyArchMACHINEFUNCTION_H
#define LLVM_LIB_TARGET_MyArch_MyArchMACHINEFUNCTION_H
...
public:
  MyArchFunctionInfo(MachineFunction& MF)
  : MF(MF), 
    VarArgsFrameIndex(0), 
#if CH >= CH3_4 //1
...
#endif // MyArch_MACHINE_FUNCTION_INFO_H
